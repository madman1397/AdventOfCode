crude = open("Input\Control\\2021\Day_3.txt").readlines()
...
#print(str("PART ONE: ")+str(int(gamma, 2)*int(epsilon, 2)))
#----------------------------------------#
#***Part Two***
#Goal: get Oxygen scrubber rating and C02 scrubber rating, then multiply them.