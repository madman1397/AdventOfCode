...
control_path = os.path.join(os.path.dirname(__file__), os.pardir, os.pardir, os.pardir, os.pardir, "Input\\Control\\2020\\Day_4.txt")
control_path = os.path.abspath(control_path)
control_file = open(control_path)
control_input = control_file.readlines()
control_file.close()
puzzle_path = control_path = os.path.join(os.path.dirname(__file__), os.pardir, os.pardir,os.pardir, os.pardir, "Input\\Max\\2020\\Day_4.txt")
